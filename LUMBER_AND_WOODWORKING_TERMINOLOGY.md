---
layout: default
title: Lumber and woodworking terminology
...
![One inch divided into halves, quarters, eighths, and sixteenths](images/fractional-inch.svg)
...
![A 2x4x8 showing nominal size, actual thickness and width, and separate length](images/2x4-dimensions.svg)
...
![Four-quarter through eight-quarter rough hardwood compared with possible finished thickness](images/hardwood-quarter-thickness.svg)
...
![Board foot volume compared with square-foot area and linear-foot length](images/lumber-sales-units.svg)
...
![Rough blank, reference face and edge, finished part, and saw kerf](images/milling-and-kerf.svg)
...
![Simplified labeled view of the table and an exploded drawer box](images/table-parts.svg)

![Dimensioned Shaker end table and its joinery](images/dimensioned-plan.png)
...
![Drawer-guide corner notch and elongated tabletop attachment hole from the source article](images/drawer-guides-and-top-attachment.jpg)
...
![Mortise and tenon, dovetail, edge joint, rabbet, groove, dado, and notch](images/basic-joinery.svg)
...
![Apron tenons, leg mortises, and the upper-rail dovetail from the source article](images/apron-and-rail-joinery.jpg)
...
![Number 8 screw gauge and one-inch screw length explained](images/screw-notation.svg)
...
![Taper, bevel, chamfer, reveal, setback, flush, proud, shy, and racking](images/shape-and-fit-terms.svg)
...
![Laying out, sawing, and refining the two inside leg tapers](images/leg-tapering.jpg)
...
![Face, edge, and end grain with rip, crosscut, resaw, flat-sawn, rift-sawn, and quarter-sawn examples](images/grain-and-cut-directions.svg)
...
![Bow, crook, cup, twist, check, knot, and wane](images/board-defects.svg)
